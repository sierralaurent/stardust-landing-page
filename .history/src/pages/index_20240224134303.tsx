...
export default function Home() {
  return (
    ...
    <main className={`flex flex-col items-center gap-20 bg-Dark`}>
      <div className={'flex flex-col items-center gap-20 py-15'}>
      ...
      <div className={'flex flex-col items-center gap-20 py-15'}>
        <div className={'flex flex-col gap-10 items-center'}>
          ...
          <p className='text-xl'>STARDUST is free for all, but paid plans come with extra perks, faster loading speeds and unlimited use.</p>
        </div>
